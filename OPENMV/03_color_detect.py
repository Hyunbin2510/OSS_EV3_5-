...
threshold_red = (170,220,170,220,170,220)   # ex) 빨간색 임계값 설정 : (100, 180, 0, 50, 0, 50)
...
def find_blobs(img, threshold):
    ...
    for y in range(0,height,5): # 간격 (5 pixel)을 두고 스캔
        for x in range(0,width,5):
            ...
            if threshold[0] <=r <=threshold[1] and threshold[2] <= g <=threshold[3] and threshold[4] <= r <=threshold[5]:
